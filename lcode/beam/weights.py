...
@nb.njit(cache=True)
def beam_particle_weights(r, xi, xi_end, r_step, xi_step_p):
    j = int(np.floor(r / r_step))
    dxi = -(xi_end - xi) / xi_step_p
    dr = r / r_step - j
    a0_xi = dxi
    a1_xi = 1 - dxi
    a0_r = 1 - dr
...
def particle_fields(r_vec, E_r_k_1, E_f_k_1, E_z_k_1, B_f_k_1, B_z_k_1, E_r_k,
    ...
    j, a00, a01, a10, a11 = beam_particle_weights(r, r_vec[2], xi_k_1, r_step, xi_step_p)
