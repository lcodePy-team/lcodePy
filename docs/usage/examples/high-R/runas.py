...
Generated by lcode version 0.2.1.
Fill free to contact team@lcode.info for assistance.
"""

config = {
    'geometry': '2d', # 'circ' or '3d' 
    ...
    'ion-model': 'background', # 'mobile' or 'background'
