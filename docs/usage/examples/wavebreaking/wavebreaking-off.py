...
config = {
    ...
    'field-solver-subtraction-coefficient': 1.03,
...
COMPRESS, BOOST, SIGMA, SHIFT = 1, 20, 1, 0
...
diag = [DiagnosticsFXi(
            ...
            f_xi='Ez,Sf,dx_chaotic_perp',
            f_xi_type='numbers'),
        DiagnosticsColormaps(output_period=0, colormaps='rho'),
        DiagnosticsTransverse(
            output_period=0, saving_xi_period=2,
            colormaps='rho',
